  ...
  return (
    <div className='homeInterior'>
      <section className="HomeInteriorMainDiv">
        ...
        <p>From Foundation to furnishing , Decoration , Designing and many More</p>
...
<div className='specialCard'>
    <div >
        ...
        <p>With an emphasis on details, extraordinary designs and exceptional customer service, we bring your dreams to life.</p>
    </div>
    <p>Know More <i className="fa-solid fa-chevron-right"></i></p>
</div>
<div className='specialCard interiorCards'>
   <img src='../src/assets/icon/wedesign.svg' alt='webdesgin'width={100}/>
        <h3>Complete Turnkey Services</h3>
        <p>With an emphasis on details, extraordinary designs and exceptional customer service, we bring your dreams to life.</p></div>
...
<h2>
From Concept to Creation: Your Furnitures Journey
 </h2>
